    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PlateCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "DisplayOrder", "IconClass", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "Satılık emlaklar", 1, "fas fa-home", true, "Satılık" },
                    { 2, "Kiralık emlaklar", 2, "fas fa-key", true, "Kiralık" }
                });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "IsActive", "Name", "PlateCode" },
                values: new object[,]
                {
                    { 1, true, "İstanbul", "34" },
                    { 2, true, "Ankara", "06" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Residential apartments", 1, "fas fa-building", true, "Daire" },
                    { 2, "Luxury villas", 2, "fas fa-house-user", true, "Villa" },
                    { 3, "Land plots", 3, "fas fa-mountain", true, "Arsa" },
                    { 4, "Commercial properties", 4, "fas fa-store", true, "İşyeri" },
                    { 5, "Office spaces", 5, "fas fa-briefcase", true, "Ofis" }
                });
